 ...
 * generated in the ru.flibasta.server.auth package. 
...
public class ObjectFactory {
    ...
    private static final QName _Authorization_QNAME = new QName("http://web.service.authserver.flibasta.ru/", "authorization");
    private static final QName _AuthorizationResponse_QNAME = new QName("http://web.service.authserver.flibasta.ru/", "authorizationResponse");
    private static final QName _Registration_QNAME = new QName("http://web.service.authserver.flibasta.ru/", "registration");
    private static final QName _RegistrationResponse_QNAME = new QName("http://web.service.authserver.flibasta.ru/", "registrationResponse");
    private static final QName _UsernameNotFoundException_QNAME = new QName("http://web.service.authserver.flibasta.ru/", "UsernameNotFoundException");
    private static final QName _InvalidPasswordException_QNAME = new QName("http://web.service.authserver.flibasta.ru/", "InvalidPasswordException");
    private static final QName _UserAlreadyExistsException_QNAME = new QName("http://web.service.authserver.flibasta.ru/", "UserAlreadyExistsException");
    private static final QName _InvalidUsernameException_QNAME = new QName("http://web.service.authserver.flibasta.ru/", "InvalidUsernameException");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.flibasta.server.auth
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://web.service.authserver.flibasta.ru/", name = "authorization")
     ...
     */
    @XmlElementDecl(namespace = "http://web.service.authserver.flibasta.ru/", name = "authorizationResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://web.service.authserver.flibasta.ru/", name = "registration")
     ...
     */
    @XmlElementDecl(namespace = "http://web.service.authserver.flibasta.ru/", name = "registrationResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://web.service.authserver.flibasta.ru/", name = "UsernameNotFoundException")
     ...
     */
    @XmlElementDecl(namespace = "http://web.service.authserver.flibasta.ru/", name = "InvalidPasswordException")
     ...
     */
    @XmlElementDecl(namespace = "http://web.service.authserver.flibasta.ru/", name = "UserAlreadyExistsException")
     ...
     */
    @XmlElementDecl(namespace = "http://web.service.authserver.flibasta.ru/", name = "InvalidUsernameException")
